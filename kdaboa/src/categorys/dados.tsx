...
export const dados: Dados[] = [
  ...
  //categorias novas
  { id: 47, title: 'Cultura Afro', icon: <Face2 /> },
  { id: 48, title: 'Pontos Turisticos', icon: <Event /> },
  { id: 49, title: 'Parques e Natureza', icon: <CrueltyFree /> },
  { id: 50, title: 'Religioso', icon: <Church /> },
  { id: 51, title: 'Afroturismo', icon: <Tour /> }
];
